...
export default async (req, context) => {
  ...
  try {
    ...
    // Get session ID from request body (generated by client)
    // Client generates a stable session ID using localStorage
    const { sessionId: clientSessionId } = await req.json();
